...
namespace Madingley
{
    ...
    public class EcologyCohort
    {
            ...
            MadingleyModelInitialisation initialisation)
        {
            ...
            Debug.Assert(gridCellCohorts[actingCohort].SomaticTracerAge.CompareTo(0.0) >= 0, "Tracer age is negative");
            Debug.Assert(gridCellCohorts[actingCohort].SomaticTracerMass.CompareTo(0.0) >= 0, "Tracer mass is negative");
