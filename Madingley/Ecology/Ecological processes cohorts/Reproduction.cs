...
namespace Madingley
{
    ...
    public class Reproduction : IEcologicalProcessWithinGridCell
    {
        ...
        public void RunEcologicalProcess(GridCellCohortHandler gridCellCohorts, GridCellStockHandler gridCellStocks, 
            ...
            uint currentTimeStep, ProcessTracker processTracker, CohortTracker cohortTracker, FunctionalGroupTracker functionalTracker, ref ThreadLockedParallelVariables partial,
